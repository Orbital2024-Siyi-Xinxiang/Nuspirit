...
public class VenueManager : MonoBehaviour
{
    ...
    public UserManager userManager; // TODO: need to be assigned 
    ...
    public void Initialize(string venueId)
    {
        ...
        // TODO: umcomment this to start managing users
        //userManager.StartManagingUsers(venueId);
    }
    ...
    public Task InitializeBookables()
    {
        ...
        dataUpdater.StartUpdatingBookables();
